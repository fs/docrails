...
* Все способы противодействия _(highlight)которые отмечены_
...
* TODO Специфическая для Rails проблема mass assignment 
...
* TODO: Instead of stealing a cookie unknown to the attacker, he fixes a user's session identifier (in the cookie) known to him. Read more about this so-called session fixation later.
...
h4. Session Storage Хранилище сессий
...
h4. Session Fixation Фиксация сессии
