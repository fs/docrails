h2. Интеграция Rails с Rack

В этом руководстве описывается интерграция Rails с Rack и интерфейсы работы с Rack компонентами. В этом руководстве вы узнаете:
