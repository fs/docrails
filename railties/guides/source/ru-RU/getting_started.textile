...
If youвЂ™d like more details on REST as an architectural style, these resources are more approachable than FieldingвЂ™s thesis:
...
If you follow this guide, youвЂ™ll create a Rails project called <tt>blog</tt>, a (very) simple weblog. Before you can start building the application, you need to make sure that you have Rails itself installed.
...
* If you want to keep up with cutting-edge changes to Rails, youвЂ™ll want to clone the "Rails source code":http://github.com/rails/rails/tree/master from github. This is not recommended as an option for beginners, though.
